...
{
    public partial class Lupa_Password_Kurir : Form
    {
        ...
        public Lupa_Password_Kurir(String id_akun)
        {
            id_kurir= int.Parse(id_akun);
            InitializeComponent();
        }
        ...
        private void btnSetuju_Click(object sender, EventArgs e)
        {
            if (modeConfirmPwd)
            {
                ...
                string updateQuery =
                    @"UPDATE kurir 
                            SET password_kurir= @NewPassword 
                ...
                using (var conn = new NpgsqlCommand(updateQuery, DBConnection.connection))
                {
                    ...
                    using (var cmd = new NpgsqlCommand(updateQuery, DBConnection.connection))
                    {
                        ...
                        {
                            MessageBox.Show(
                                "Gagal memperbarui password. id_kurirtidak ditemukan.",
                                "Perhatian",
                                MessageBoxButtons.OK,
